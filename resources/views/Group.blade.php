...
<div class="container mx-auto grid grid-cols-3">
    @foreach ($category as $book)
            <a href="#" class="px-auto mx-10 my-10 py-auto flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
